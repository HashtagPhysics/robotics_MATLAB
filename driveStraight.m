function [robot, endTime] = driveStraight(robot, distance_in, motorSpeed_M, startTime)
    ...
    v_max_ips = sqrt(accel_in_s2 * distance_in);
    ...
    t_total_s = distance_in / v_arb_command_ips + v_arb_command_ips / accel_in_s2;
